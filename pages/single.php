...
<html>
<head>
    <title>Java Video Lessons</title>
    <meta charset="utf-8">
  ...
  <div id="pagewrap">
    <nav>
      ...
      <div class="navbar-header"style="padding-top: 20px;  padding-left: 20px;">
          ...
          <a class="navbar1-brand1 "> <a href="../index.php"><img alt="logo"  src="../images/logo1.png"></a>
          </a>
        </div>
          </nav>
...
<li class="active"> <b> Java පරිගණක භාෂාව</b></li> 
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a class="panel-group" input type = "panel" id="button2"  value = "Load Data">
                                        <div class="panel panel-default"><div class="containersd">
                                            <div class="panel-heading">
                                              ...
                                              Java Programming වලට ඔබගේ පරිගණකය සකසා ගැනීම- part 1
                                                </h4>
                                            </div></div>
                                        </div>
                                    </a>
                                    ...
                                    <a class="panel-group" input type = "panel" id="button3"  value = "Load Data">
                                        <div class="panel panel-default"><div class="containersd">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    Java Programming වලට ඔබගේ පරිගණකය සකසා ගැනීම- part 2
                                                </h4>
                                            </div>
                                        </div>  </div>
                                    </a>
                                    ...
                                    <a class="panel-group" input type = "panel" id="button4"  value = "Load Data">
                                        <div class="panel panel-default"><div class="containersd">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                  Java මගින් Output එකක් ලබා ගැනීම
                                                </h4>
                                            </div></div>
                                        </div>
                                    </a>
                                    <a class="panel-group" input type = "panel" id="button5"  value = "Load Data">
                                        <div class="panel panel-default"><div class="containersd">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    Java Variables වල ක්‍රියාකාරීත්වය - part 1
                                                </h4>
                                            </div></div>
                                        </div>
                                    </a>
                                    ...
                                    <a class="panel-group" input type = "panel" id="button6"  value = "Load Data">
                                        <div class="panel panel-default"><div class="containersd">
                                                <div class="panel-heading">
                                                    <h4 class="panel-title">
                                                       Java සඳහා Arithmatic Operators 
                                                    </h4>
                                                </div>
                                            </div></div>
                                    </a>
                                    <a class="panel-group" input type = "panel" id="button6"  value = "Load Data">
                                        <div class="panel panel-default"><div class="containersd">
                                                <div class="panel-heading">
                                                    <h4 class="panel-title">
                                                         Java සඳහා Relational Operators 
                                                    </h4>
                                                </div>
                                            </div></div>
                                    </a>
